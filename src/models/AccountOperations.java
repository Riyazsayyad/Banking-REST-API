...
public class AccountOperations {
   ...
   public Account getAccountinfobyno(String accno) {
	   ...
	   try {
		   Session Ses;
			...
			Ses=sf.getCurrentSession();
			Ses.beginTransaction();
			Query q=Ses.createQuery("from Account where accno=:no",Account.class);
   ...
   public String deleteAccount(String accno){
		...
		try {
			...
			Ses=sf.getCurrentSession();
			Ses.beginTransaction();
			Query q=Ses.createQuery("delete from Account where accno=:id",Account.class);
 ...
 public String TransferAmount(Transactions obj) {
	 ...
	 try {
		 Session Ses;
			...
			Query q1=Ses1.createQuery("update Account set balance=balance-:bal where accno=:faccno",Account.class);
			...
			Ses1.getTransaction().commit();
			 ...
			 Session Ses2;
				...
				Query q2=Ses2.createQuery("update Account set balance=balance+:bal where accno=:taccno",Account.class);
